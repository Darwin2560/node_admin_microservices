...
db_1.AppDataSource.initialize().then(function () {
    var productsRespository = db_1.AppDataSource.getRepository(product_1.Product);
        ...
        conn.createChannel(function (err, channel) {
            ...
            app.get('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productsRespository.find()];
                        case 1:
                            products = _a.sent();
            ...
            app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productsRespository.create(req.body)];
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, productsRespository.save(product)];
                        case 2:
                            result = _a.sent();
            ...
            app.get('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productsRespository.findOne({ where: { id: Number(req.params.id) } })];
                        case 1:
                            product = _a.sent();
            ...
            app.delete('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productsRespository.delete(req.params.id)];
                        case 1:
                            result = _a.sent();
